...
//import edu.asupoly.ser422.view.DisplayResultView;
...
//		pageBuffer.append("<html>\n<head>\n<title>Booktown Servlet</title>\n</head>\n<body>\n<H2>Authors:</H2>\n");
		...
		try {
			...
			if (bookstore == null) {
				...
				//	out.println("Servlet execution error: The bookstore is closed.");
				 req.setAttribute("bookstore",bookstore);
	             req.getRequestDispatcher("WEB-INF/src/edu/asupoly/ser422/view/DisplayResultView.jsp").forward(req, res);    
				return;
			}
		}
		catch (Throwable t) {
        ...
        req.setAttribute("authid",authorId);
        req.setAttribute("buildView",buildView);
